...
<script type="text/javascript">
    ...
    $('select[name=kategori]').select2({
		ajax : {
          url : "<?php echo e(url('walidata/'.Crypt::encryptString('get_kategori'))); ?>",
          type : 'POST',
          dataType : 'json',
          delay : 250,
          data : function(params) {
	...
	$('#save').click(function() {
		if ($(this).data('action') == 'save') {
			var url = "<?php echo e(url('walidata/'.Crypt::encryptString('save'))); ?>";
		}
		else{
			var url = "<?php echo e(url('walidata/user/'.Crypt::encryptString('update'))); ?>";
		}
		$.ajax({
			url : url,
			type : 'POST',
